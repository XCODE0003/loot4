...
import FooterUpSocial from '@/components/layout/footer/FooterUpSocial.vue'
import FooterBottomSocial from '@/components/layout/footer/FooterBottomSocial.vue'
    ...
    <div class="container">
      <div class="footer_up">
        <div class="footer_up_item">
          ...
          <RouterLink to="/" class="footer_up_item_logo">
